...
export interface CityInfo {id: string, label: string, lat: number, lon: number, tempC: number, weatherIcon: string, windMs: number, windDeg: number,  pressure: number, weatherMain: string}
